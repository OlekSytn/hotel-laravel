...
trait UsesRoleForms {
    ...
    {
        return $this->form('ReactorCMS\Html\Forms\Roles\CreateEditForm', [
            'method' => 'POST',
    ...
    {
        $this->validateForm('ReactorCMS\Html\Forms\Roles\CreateEditForm', $request);
    }
    ...
    {
        $form = $this->form('ReactorCMS\Html\Forms\Users\AddUserForm', [
