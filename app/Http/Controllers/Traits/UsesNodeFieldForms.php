...
trait UsesNodeFieldForms {
    ...
    {
        return $this->form('ReactorCMS\Html\Forms\NodeFields\CreateForm', [
    ...
    {
        $this->validateForm('ReactorCMS\Html\Forms\NodeFields\CreateForm', $request, [
    ...
    {
        return $this->form('ReactorCMS\Html\Forms\NodeFields\EditForm', [
    ...
    {
        $this->validateForm('ReactorCMS\Html\Forms\NodeFields\EditForm', $request);
    }
