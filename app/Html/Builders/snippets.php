...
if ( ! function_exists('action_button'))
{
     ...
     * @return string
     */
    function action_button($link, $icon, $text = '', $class = '', $iconSide = 'r')
    {
...
if ( ! function_exists('delete_form'))
{
     ...
     * @return string
     */
    function delete_form($action, $text, $input = '', $specific = false, $icon = 'fa-trash')
    {
...
if ( ! function_exists('delete_form_link'))
{
    ...
    {
        return app('reactor.builders.forms')->deleteFormLink($action, $text, $input, $specific, $icon);
    }
}
