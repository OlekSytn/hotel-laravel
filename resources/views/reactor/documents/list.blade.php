        ...
        @foreach($documents as $document)
            <li class="document">
                ...
                <div class="document__options">
                    ...
                    <form action="{{ route('reactor.documents.destroy', $document->getKey()) }}" method="POST"
                          class="document__option delete-form">
                        {!! method_field('DELETE') . csrf_field() !!}
                        <button class="button button--danger document__option-button option-delete" type="submit"><i
                                    class="button__icon button__icon--action icon-trash"></i></button>
                    </form>
                </div>
